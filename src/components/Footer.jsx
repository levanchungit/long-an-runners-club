export default function Footer() {
  return (
    <footer id="footer" className="bg-gray-900 text-white relative">
      {/* Decorative Wave matches the dark background */}
      ...
      <div className="relative max-w-6xl mx-auto px-5 sm:px-8 mt-[-3rem] z-10 pt-16">
        <div className="relative rounded-[2rem] overflow-hidden shadow-[0_20px_60px_rgba(255,107,53,0.3)] border border-orange-400/20">
          <div className="absolute inset-0 bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700" />
          
          {/* Abstract circles */}
          <div className="absolute -top-32 -left-32 w-64 h-64 rounded-full bg-white/10 blur-3xl mix-blend-overlay" />
          <div className="absolute -bottom-32 -right-32 w-80 h-80 rounded-full bg-orange-300/20 blur-3xl mix-blend-overlay" />
          ...
          <div className="relative p-8 sm:p-14 md:p-16 text-center flex flex-col items-center md:flex-row md:items-center md:justify-between md:text-left gap-6 md:gap-8">
            ...
            <a
              ...
              className="inline-flex shrink-0 items-center justify-center gap-2 px-8 py-4 bg-white text-orange-600 font-bold text-[15px] rounded-full shadow-[0_8px_25px_rgba(0,0,0,0.15)] hover:shadow-[0_12px_30px_rgba(0,0,0,0.25)] hover:-translate-y-1 transition-all duration-300"
            >
              Liên hệ tham gia
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gray-800 border border-gray-700 hover:bg-orange-500 hover:border-orange-500 text-gray-300 hover:text-white rounded-xl flex items-center justify-center transition-all shadow-sm"
                aria-label="Facebook"
              >
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400 text-[14px]">
              <li className="flex items-start gap-3 w-full">
                <svg className="w-4 h-4 mt-1 text-orange-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-[14px]">
              {['VietRace365', 'Vietnam Running Awards', 'Phong Trào Chạy Bộ VN'].map((link) => (
                <li key={link}>
                  <a href="#" className="hover:text-orange-500 transition-colors flex items-center gap-1.5 group">
                    {link}
                    <svg className="w-3 h-3 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-[14px]">
              {['Trang chủ', 'Giới thiệu', 'Hoạt động', 'Thư viện hình ảnh'].map((link) => (
                <li key={link}>
